...
public class NouveauFortunesWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(NouveauFortunesWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/NouveauFortunesWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/NouveauFortunesWLAIW/InitOutcome.xml").getDocumentElement();
